...
<html>
    ...
    <body>
        ...
        <div id="show-commande" class="content scaffold-show" role="main">
            ...
            <f:display bean="commande" />
            <g:form resource="${this.commande}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.commande}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
