...
<html>
    ...
    <body>
        ...
        <div id="show-categorie" class="content scaffold-show" role="main">
            ...
            <f:display bean="categorie" />
            <g:form resource="${this.categorie}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.categorie}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
