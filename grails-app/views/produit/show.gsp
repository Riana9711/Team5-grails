...
<html>
    ...
    <body>
        ...
        <div id="show-produit" class="content scaffold-show" role="main">
            ...
            <f:display bean="produit" />
            <g:form resource="${this.produit}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.produit}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
